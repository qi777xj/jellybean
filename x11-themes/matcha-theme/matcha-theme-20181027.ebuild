...
src_unpack() {
	...
	cd "$S"
	curl https://dl.opendesktop.org/api/files/downloadfile/id/1540647883/s/${HASH_TIME[0]}/t/${HASH_TIME[1]}/Matcha-sea.tar.xz -o Matcha-sea.tar.xz
	curl https://dl.opendesktop.org/api/files/downloadfile/id/1540647838/s/${HASH_TIME[0]}/t/${HASH_TIME[1]}/Matcha-azul.tar.xz -o Matcha-azul.tar.xz
	curl https://dl.opendesktop.org/api/files/downloadfile/id/1540647854/s/${HASH_TIME[0]}/t/${HASH_TIME[1]}/Matcha-aliz.tar.xz -o Matcha-aliz.tar.xz
	curl https://dl.opendesktop.org/api/files/downloadfile/id/1540647869/s/${HASH_TIME[0]}/t/${HASH_TIME[1]}/Matcha-dark-sea.tar.xz -o Matcha-dark-sea.tar.xz
	curl https://dl.opendesktop.org/api/files/downloadfile/id/1540647877/s/${HASH_TIME[0]}/t/${HASH_TIME[1]}/Matcha-dark-azul.tar.xz -o Matcha-dark-azul.tar.xz
	curl https://dl.opendesktop.org/api/files/downloadfile/id/1540647831/s/${HASH_TIME[0]}/t/${HASH_TIME[1]}/Matcha-dark-aliz.tar.xz -o Matcha-dark-aliz.tar.xz
	unpack "${S}"/*.tar.xz
}
